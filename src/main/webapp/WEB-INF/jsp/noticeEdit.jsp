...
<head>
    ...
    <title>공지사항 수정 - ${no_detail.title}</title>
            ...
            <div class="card-body">
                ...
                <form   action="${path}/updateNotice" enctype="multipart/form-data">
                    <table class="table border-secondary">
                        ...
                        <tr>
                            <th scope="row">
                                <input type="text" value="${no_detail.title}" name="title" style="width:100%">
                            </th>
                            <td id="create_date"><fmt:formatDate value="${no_detail.create_date}" pattern="yyyy-MM-dd"/></td>
                        </tr>
                        <tr>
                            <td colspan="2" id="writer">작성자 :
                                <input type="text" value="${no_detail.writer}" name="writer" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                ...
                <div class="text-end">
                    <button id="finBtn" class="btn btn-primary btn-sm" type="button" >수정완료</button>
                </div>
...
if(proc=="upt"){
    alert("수정이 완료되었습니다.")
    location.href="${path}/noticeDetailPage?notice_no=${param.notice_no}"
}
if(proc=="del"){
    alert("삭제되었습니다.")
    location.href="${path}/noticePage"
